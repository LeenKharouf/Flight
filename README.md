[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=10234419&assignment_repo_type=AssignmentRepo)
# Course Project
...
![screenshot of code output](images/codeoutput.png)

I declare that I have read and completed the above checked item in the list: Leen Kharouf, March 3, 2023
...
- *Concept #1*: vectors, *File name / Line numbers(s)*: main.cpp / 65,178
- *Concept #2*: inline function, *File name / Line numbers(s)*: main.cpp / 151
- *Concept #3*: passing vector by reference, *File name / Line numbers(s)*: main.cpp / 135
- *Concept #4*: pointers, *File name / Line numbers(s)*: main.cpp / 57
...
- *Concept #1*: Classes, *File name / Line numbers(s)*: all header files
- *Concept #2*: inheritcance, *File name / Line numbers(s)*: Flight.h / 90
- *Concept #3*: Function overriding, *File name / Line numbers(s)*: main.cpp / line 130
- *Concept #4*: virtual functions, *File name / Line numbers(s)*: Flight.h / 81,85
- EXTRA Concept: outfile, *File name / Line numbers(s)*: Passenger.h / 87
